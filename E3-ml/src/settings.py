...
class DataSettings():
    E1_API_BASE_URL = DATA_CONFIG["E1_API_BASE_URL"]
    E1_API_LOGIN_URL = DATA_CONFIG["E1_API_LOGIN_URL"]
    E1_API_OHLCV_URL = DATA_CONFIG["E1_API_OHLCV_URL"]

    CSV_DIR_PATH = DATA_CONFIG["CSV_DIR_PATH"]
